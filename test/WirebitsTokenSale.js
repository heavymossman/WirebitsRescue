...
contract('WirebitsTokenSale', function(accounts) {
  var tokenInstance;
  var tokenSaleInstance;
  var admin = accounts[0];
  var buyer = accounts[3];
  var tokenPrice = 10000000000000000; // in wei
  var tokensAvailable = 7500000; //going to send 75% of all tokens to the ICO contract
  var numberOfTokens;

  it('initializes the contract with the correct values', function() {
    return WirebitsTokenSale.deployed().then(function(instance) {
  ...
  it('facilitates token buying', function() {
    return WirebitsToken.deployed().then(function(instance) {
      ...
      return WirebitsTokenSale.deployed();
